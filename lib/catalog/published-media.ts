// Representative images selected for the visual release. This is not a bulk catalog publication.
export const publishedMedia: Record<string, string> = {
  EK42X50: "/products/representative-shock-absorber.jpg",
