  ...
  engineer: {
    ...
    result: {
      ...
      labels: {
        ...
        averageImpactForce: "Average force (N)",
...
const chineseCopy: SiteCopy = {
  ...
  contact: {
    ...
    contactLabels: ["销售", "服务"],
    channels: [
      { label: "销售", value: "sales@vibroabsorber.com", href: "mailto:sales@vibroabsorber.com" },
      { label: "服务", value: "service@vibroabsorber.com", href: "mailto:service@vibroabsorber.com" },
    ],
    socialTitle: "在线联系渠道",
    socialDescription:
    ...
    form: {
      ...
      errorTitle: "发送失败",
      errorMessage: "消息发送失败，请稍后重试或直接发送邮件至 sales@vibroabsorber.com。",
...
const germanCopy: SiteCopy = {
  ...
  engineer: {
    ...
    result: {
      ...
      labels: {
        ...
        averageImpactForce: "Mittlere Kraft (N)",
  ...
  contact: {
    ...
    contactLabels: ["Vertrieb", "Service"],
    channels: [
      { label: "Vertrieb", value: "sales@vibroabsorber.com", href: "mailto:sales@vibroabsorber.com" },
      { label: "Service", value: "service@vibroabsorber.com", href: "mailto:service@vibroabsorber.com" },
    ],
...
const frenchCopy: SiteCopy = {
  ...
  contact: {
    ...
    channels: [
      { label: "Ventes", value: "sales@vibroabsorber.com", href: "mailto:sales@vibroabsorber.com" },
      { label: "Service", value: "service@vibroabsorber.com", href: "mailto:service@vibroabsorber.com" },
    ],
...
const italianCopy: SiteCopy = {
  ...
  contact: {
    ...
    channels: [
      { label: "Vendite", value: "sales@vibroabsorber.com", href: "mailto:sales@vibroabsorber.com" },
      { label: "Service", value: "service@vibroabsorber.com", href: "mailto:service@vibroabsorber.com" },
    ],
